@props(['title', 'items' => []])
<div class="my-10 flex flex-col gap-6 mx-4">
    <div data-aos-duration="1000" data-aos="fade-up" class="relative h-12 flex flex-col justify-center">
        ...
        <div class="absolute left-0 right-0 flex justify-center">
            <h3 class="uppercase font-bold text-2xl px-8 rounded-full h-12 bg-primary-500 flex flex-col justify-center text-white">
                {{ $title }}
            </h3>
        </div>
    </div>

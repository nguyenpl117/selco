    ...
    <div class="my-10">
        <div class="max-w-screen-2xl mx-auto">
            <div class="grid grid-cols-1 lg:grid-cols-12 gap-4">
                <div class="px-4 col-span-5 flex flex-col justify-center">
                    <div class="flex flex-col gap-4" data-aos="fade-right">
                        <div class="flex justify-between">
                            <h2 class="font-bold font-svn-medium text-[34px]">{{ $page_title }}</h2>
                        </div>
                        <div>
                            <p>
                                Công ty TNHH MTV Sông Đà 11 Thăng Long (SELCO SONG DA) là đơn vị thành viên của Tổng công ty
                                Sông Đà, đã tham gia thi công xây lăp nhiều dự án quan trọng của đất nước về thủy điện, hệ
                                thống đường dây truyền tải điện cao thế, hệ thống cấp thoát nước trong các khu đô thị và
                                công nghiệp…
                            </p>
                        </div>
                    </div>
                        ...
                        <div class="grid grid-cols-2 gap-8">
                            <div>
                                <p class="number pb-[26px] text-[yellow] text-[20px] font-light font-svn">
                                    <span class="count-up active text-[48px] font-svn-medium font-bold mr-2.5">294</span>tỉ đồng
                                </p>
                                <p class="subtitle border-t pt-5 pb-7">Doanh thu</p>
                            </div>
                            <div>
                                <p class="number pb-[26px] text-[yellow] text-[20px] font-light font-svn">
                                    <span class="count-up active text-[48px] font-svn-medium font-bold mr-2.5">36</span>tỉ đồng
                                </p>
                                <p class="subtitle border-t pt-5 pb-7">Lợi nhuận sau thuế</p>
                            </div>
                            <div>
                                <p class="number pb-[26px] text-[yellow] text-[20px] font-light font-svn">
                                    <span class="count-up active text-[48px] font-svn-medium font-bold mr-2.5">18036</span>tỉ đồng
                                </p>
                                <p class="subtitle border-t pt-5 pb-7">Tổng tài sản</p>
                            </div>
                            <div>
                                <p class="number pb-[26px] text-[yellow] text-[20px] font-light font-svn">
                                    <span class="count-up active text-[48px] font-svn-medium font-bold mr-2.5">689</span>tỉ đồng
                                </p>
